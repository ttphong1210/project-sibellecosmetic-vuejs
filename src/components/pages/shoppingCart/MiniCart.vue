<template>
 <a href="/cart/show.html" class="icons" style="padding-right:10px;">
...
<ul class="submenu-dropdown submenu-dropdown-list list-submenu-cart">
    <li class="nav-item" style="padding: 10px 15px;">
        ...
        <table>
            <tbody>
                <tr v-for="item in cartItems" :key="item.id" class="items-minicart">
                    <td style="width: 30%;">
                        <img width="100%" :src="'http://127.0.0.1:8080/storage/avatar/'+item.img_url">
                    </td>
        ...
        <div class="minicart-button d-flex">
            <div class="col-md-6">
                <button class="link-to-cart"><a href="/cart/show.html">Xem giỏ hàng</a></button>
            </div>
            <div class="col-md-6">
            <button class="link-to-checkout">
              <a :href="cartCount > 0 ? '/checkout.html' : '/products.html'">
